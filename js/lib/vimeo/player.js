...
!function(e, t) {
    ...
    var M, C, N, F, L = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    function R() {
        if (void 0 === this)
            throw new TypeError("Constructor WeakMap requires 'new'");
        if (F(this, "_id", "_WeakMap_" + I() + "." + I()),
        0 < arguments.length)
    ...
    (M = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : L).WeakMap || (C = Object.prototype.hasOwnProperty,
    ...
    F(R.prototype, "set", function(e, t) {
        ...
        var n = e[this._id];
        return n && n[0] === e ? n[1] = t : F(e, this._id, [e, t]),
        this
    }),
    F(R, "_polyfill", !0),
    R));
    ...
    var K, ee, te, ne = {
        ...
        a
    }(), oe = new WeakMap, ie = new WeakMap, ae = {}, Player = function() {
        function Player(u) {
            ...
            "IFRAME" === u.nodeName && !x(u.getAttribute("src") || ""))
            ...
            return ie.set(this, o),
            oe.set(this.element, this),
            "IFRAME" === this.element.nodeName && H(this, "ping"),
            ae.isEnabled && (r = function() {
                return ae.exit()
            }
            ,
            ...
            ,
            ae.on("fullscreenchange", this.fullscreenchangeHandler)),
            this
        }
        var n;
        return e(Player, [{
            ...
            value: function() {
                ...
                return new U(function(e) {
                    ...
                    ie.delete(n),
                    oe.delete(n.element),
                    n._originalElement && (oe.delete(n._originalElement),
    ...
    te = {
        ...
        exit: function() {
            return new Promise(function(t, e) {
                ...
                ,
                te.on("fullscreenchange", n),
                (r = document[K.exitFullscreen]())instanceof Promise && r.then(n).catch(e)) : t()
            }
            )
        },
        on: function(e, t) {
    ...
    function(e) {
        var o, i = 0 < arguments.length && void 0 !== e ? e : document;
            ...
            if (t && "drminitfailed" === t.event) {
                ...
                if (n) {
                    ...
                    if (!r.includes("encrypted-media")) {
                        ...
                        return o.searchParams.set("forcereload", "drm"),
                        void n.setAttribute("src", o.toString())
                    }
                }
            }
        }
